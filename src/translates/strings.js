const strings = {
  az: {
    ...
    to_date: 'Son tarix',
    day_of_week: 'Gün',
    choose_day_of_week: 'Günləri seçin',
    type: 'Növ',
    earning: 'Gəlir',
    expense: 'Xərc',
    amount: 'Məbləğ',
    ...
    expense_added_error: 'Gəlir/xərcin əlavə olunması üçün bütün xanalar doldurulmalıdır',
    summary: 'cəmi',
    balance: 'Balans',
  ...
  en: {
    ...
    to_date: 'To date',
    day_of_week: 'Day',
    choose_day_of_week: 'Choose week days',
    type: 'Type',
    earning: 'Income',
    expense: 'Expense',
    amount: 'Amount',
  ...
  ru: {
    ...
    to_date: 'Дата по',
    day_of_week: 'День',
    choose_day_of_week: 'Выберите дни',
    type: 'Тип',
    earning: 'Доход',
    expense: 'Расход',
    amount: 'Сумма',
    ...
    expense_added_error: 'Не все поля заполнены',
    summary: 'всего',
    balance: 'Баланс',
